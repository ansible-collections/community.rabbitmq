...
We recommend using the [AGENTS.md](https://github.com/ansible-collections/community.rabbitmq/blob/main/AGENTS.md) file and [skills](https://github.com/ansible-collections/community.rabbitmq/tree/main/.agents/skills) provided in this repository when contributing with AI tools' assistance.
